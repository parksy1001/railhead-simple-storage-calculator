...
export const CAMERA_RESOLUTION_PROFILES = {
  NORMAL_2MP: {
    ...
    dualAllowed: [RESOLUTIONS.RES_640_360, RESOLUTIONS.RES_352_240],
  },
  ...
  FISHEYE_5MP: {
    ...
    dualAllowed: [RESOLUTIONS.RES_640_512, RESOLUTIONS.RES_640_256],
  },
};
...
export const HDD_SIZE_OPTIONS = [0.125, 0.25, 0.5, 1, 2, 4, 8, 16];
...
export const RAID_INFO = {
  ...
  RAID5:
    'Distributes parity information across disks to tolerate a single disk failure. (N-1 usable capacity, minimum 4 disks required)',
  RAID6:
    'Uses dual parity to tolerate up to two simultaneous disk failures. (N-2 usable capacity, minimum 4 disks required)',
  RAID10:
    'Combines mirroring and striping to provide high performance and fault tolerance. (50% usable capacity, minimum 4 disks required)',
};
...
export const PRESET_SCENES = [
  {
    id: 'Shopping',
    name: 'Shopping Mall',
    time: { resIndex: 0, fps: 30, qual: 'High', codec: 'H.265', hours: 4 },
    event: { resIndex: 0, fps: 30, qual: 'Very High', codec: 'H.265', hours: 8 },
  },
  {
    id: 'Hotel/Casino',
    name: 'Hetel/Casino',
    time: { resIndex: 0, fps: 10, qual: 'Very High', codec: 'H.265', hours: 12 },
    event: { resIndex: 0, fps: 30, qual: 'Very High', codec: 'H.265', hours: 12 },
  },
  {
    id: 'Residence',
    name: 'Residence',
    time: { resIndex: 1, fps: 10, qual: 'High', codec: 'H.265', hours: 6 },
    event: { resIndex: 0, fps: 30, qual: 'Very High', codec: 'H.265', hours: 12 },
  },
  {
    id: 'Education',
    name: 'Education',
    time: { resIndex: 1, fps: 10, qual: 'High', codec: 'H.265', hours: 6 },
    event: { resIndex: 0, fps: 20, qual: 'Very High', codec: 'H.265', hours: 6 },
  },
  {
    id: 'Retail',
    name: 'Retail',
    time: { resIndex: 0, fps: 10, qual: 'Standard', codec: 'H.265', hours: 4 },
    event: { resIndex: 0, fps: 30, qual: 'Very High', codec: 'H.265', hours: 4 },
  },
  {
    id: 'Logistics',
    name: 'Logistics',
    time: { resIndex: 0, fps: 10, qual: 'Standard', codec: 'H.265', hours: 10 },
    event: { resIndex: 0, fps: 30, qual: 'Very High', codec: 'H.265', hours: 4 },
  },
];
